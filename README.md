...
- [Why This Approach?](#why-this-approach)
  ...
  - [OpenRouter API for LLM](#groq-api-for-llm)
...
- **Model-View-Controller (MVC)** Pattern:
  - **Model**: Handles data preprocessing (`document.py`), hybrid vector store (`tfidf_store.py`), Deepseek LLM (`groq_llm.py`{i intentionally did not change the naming even though i am no longer ussing groq}), and RAG agent (`rag_agent.py`).
